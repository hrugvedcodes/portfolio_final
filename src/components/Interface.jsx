...
const AboutSection = (props) => {
  ...
  return (
    <Section mobileTop>
      ...
      >
        I am Hrugved Lakhapati, a proficient Java developer with a strong foundation in Data Structures and Algorithms. With an extensive repertoire of problem-solving skills, I have successfully tackled over 600 algorithmic challenges on platforms like LeetCode. Moreover, my expertise extends to full-stack web development, particularly in the MERN (MongoDB, Express.js, React.js, Node.js) stack. I possess hands-on experience in building dynamic and scalable web applications, leveraging the capabilities of each component of the MERN stack to deliver efficient and robust solutions. Alongside my technical prowess, I bring a passion for continuous learning and a commitment to delivering high-quality code. Through my educational background and practical experience, I have honed my abilities to contribute effectively to any development team, driving innovation and achieving project goals.
      </motion.p>
...
const SkillsSection = () => {
  const skills = [
    { category: "Development", items: ["MongoDB", "ReactJs", "NodeJs", "TailwindCss", "Javascript", "react-three"] },
    { category: "Deployment", items: ["Vercel", "Github", "Netlify"] },
    { category: "Architecture", items: ["Java", "JavaScript", "Python", "C++", "Prompt Engineering"] }
  ];

  return (
    <Section>
      <motion.div className="w-full" whileInView={"visible"}>
        <h2 className="text-[40px] font-bold uppercase mb-8">Skills</h2>
        {skills.map((skillCategory, index) => (
          <div key={index} className="mb-6">
            <h2 className="text-[30px] font-bold uppercase">{skillCategory.category}</h2>
            <div className="flex flex-wrap gap-4 mt-4">
              {skillCategory.items.map((skill, idx) => (
                <div key={idx} className="glow-border inline-block px-4 py-2 rounded-md">
